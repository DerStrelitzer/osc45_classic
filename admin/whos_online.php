...
?>
                ...
                <td class="dataTableContent"><?php echo substr($whos_online['full_name'], 0,4); ?></td>
...
?>
              <tr class="dataTableRow">
               <td colspan="7" class="dataTableContent"><b>UserAgent:</b> <?php echo $whos_online['full_name']; ?></td>
              </tr>
<?php
} // Ingo end
?>
    ...
    if ($length = strlen($session_data)) {
      ...
      if (is_object($cart)) {
        ...
        for ($i = 0, $n = sizeof($products); $i < $n; $i++) {
          $contents[] = array('text' => $products[$i]['quantity'] . ' &times; ' . $products[$i]['name']);
        }
