...
?>
          <tr><?php echo tep_draw_form('mail', FILENAME_MAIL, 'action=send_email_to_user'); ?>
            <td><table border="0" width="100%" cellpadding="0" cellspacing="2">
              ...
              <tr>
                <td class="smallText"><b><?php echo TEXT_MESSAGE; ?></b><br><?php echo nl2br(htmlspecialchars(stripslashes($_POST['message']), ENT_COMPAT, CHARSET, false)); ?></td>
              </tr>
              <tr>
                <td><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
              </tr>
...
<?php
    $customers = [
        ['id' => '', 'text' => TEXT_SELECT_CUSTOMER],
        ['id' => '***', 'text' => TEXT_ALL_CUSTOMERS],
        ['id' => '**D', 'text' => TEXT_NEWSLETTER_CUSTOMERS]
    ];
