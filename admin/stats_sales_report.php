...
$sales_report_view = isset($_GET['report']) && $_GET['report'])!='' ? $_GET['report'] : $sales_report_default_view;
...
$report = new SalesReport($sales_report_view, $startDate, $endDate);
...
<!-- body_text //-->
		<td width="100%" valign="top">
			<table border="0" width="100%" cellspacing="0" cellpadding="2">
				<tr>
					<td colspan="2" class="pageHeading"><?php echo $report_desc . ' ' . HEADING_TITLE; ?></td>
				</tr>
			    <tr>
					<td colspan="2">
