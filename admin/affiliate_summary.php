<?php
/*
  $Id: affiliate_summary.php,v 1.11 2003/03/13 17:13:06 simarilius Exp $
...
$affiliate_amount = floatval($affiliate_sales['total']);
if ($affiliate_transactions > 0) {
    $affiliate_average = $currenvies->display_price(tep_round($affiliate_amount / $affiliate_transactions, 2));
} else {
            ...
            <td><table width="100%" border="0" cellpadding="4" cellspacing="2" class="dataTableContent">
              <center>
                ...
                <tr>
                  ...
                  <td width="15%" class="dataTableContent"><?php echo $currencies->display_price($affiliate_amount, 0); ?></td>
                  ...
                  <td width="15%" class="dataTableContent"><?php echo $affiliate_average; ?></td>
                </tr>
                <tr>
                  ...
                  <td width="15%" class="dataTableContent"><b><?php echo $currencies->display_price($affiliate_commission, 0); ?></b></td>
                </tr>
                <tr>
