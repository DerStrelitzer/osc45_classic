...
define('DATE_FORMAT_SHORT', 'm/d/Y');  // this is used for date()
...
define('BOX_CATALOG_MISSING_IMAGES', 'Missing Images');

// customers box text in includes/boxes/customers.php
define('BOX_HEADING_ORDERS', 'Orders');
define('BOX_CUSTOMERS_ORDERS', 'Orders');
define('BOX_CUSTOMERS_CUSTOMERS', 'Customers');
define('BOX_CUSTOMERS_CREATE_ORDER', 'Create a order');
define('BOX_CUSTOMERS_EDIT_ORDER', 'Edit this order');
