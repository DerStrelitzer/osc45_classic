...
// besondere Produkte
define('BOX_CATALOG_FEATURED_PRODUCTS', 'Besondere Produkte');

// Nachrichten
define('BOX_CATALOG_LATEST_NEWS', 'Nachrichten');
...
define('BOX_CATALOG_MISSING_IMAGES', 'Fehlende Bilder');
...
define('BOX_CUSTOMERS_CREATE_ORDER', 'Manuelle Bestellung');
define('BOX_CUSTOMERS_EDIT_ORDER', 'Bestellung erstellen');
...
define('BOX_REPORTS_ORDERS_PERIOD', 'Verkauf nach Periode');
...
define('WARNING_INSTALL_DIRECTORY_EXISTS', 'Warnung: Das Installationverzeichnis ist noch vorhanden auf: ' . dirname($_SERVER['SCRIPT_FILENAME']) . '/install. Bitte löschen Sie das Verzeichnis aus Gründen der Sicherheit!');
define('WARNING_CONFIG_FILE_WRITEABLE', 'Warnung: osC kann in die Konfigurationsdatei schreiben: ' . dirname($_SERVER['SCRIPT_FILENAME']) . '/includes/configure.php. Das stellt ein mögliches Sicherheitsrisiko dar - bitte korrigieren Sie die Benutzerberechtigungen zu dieser Datei!');
