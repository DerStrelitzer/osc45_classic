...
define('BOX_CUSTOMERS_CREATE_ORDER', 'Crear Pedido');
define('BOX_CUSTOMERS_EDIT_ORDER', 'Modificar la Pedido');
...
define('BOX_REPORTS_ORDERS_PERIOD', 'Sales in period');
...
define('WARNING_FILE_UPLOADS_DISABLED', 'Warning: Se ha desactivado la subida de archivos en el fichero de configuración php.ini.');
...
define('WARNING_CONFIG_FILE_WRITEABLE', 'Advertencia: Puedo escribir en el fichero de configuración: ' . dirname($_SERVER['SCRIPT_FILENAME']) . '/includes/configure.php. En determinadas circunstancias esto puede suponer un riesgo - por favor corriga los permisos de este fichero.');
