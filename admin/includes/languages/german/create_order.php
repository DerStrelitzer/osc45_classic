...
define('ENTRY_REGISTER_ONLY', 'Nur Kunde registrieren, <b>kein</b> Auftrag');
...
if (isset($_POST) && is_array($_POST) && count($_POST)) {
  ...
  define('EMAIL_GREET_MR', 'Sehr geehrter Herr ' . xprios_prepare_post('lastname') . ',' . "\n\n");
  define('EMAIL_GREET_MS', 'Sehr geehrte Frau ' . xprios_prepare_post('lastname') . ',' . "\n\n");
  define('EMAIL_GREET_NONE', 'Sehr geehrte ' . xprios_prepare_post('firstname') . ',' . "\n\n");
