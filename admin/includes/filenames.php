...
// Ingo
  ...
  define('FILENAME_CAO_OSC', 'cao_update.php');
  define('FILENAME_OSC_CAO', 'xml_export.php');
  define('FILENAME_SPIDERS', 'spiders.php');
...
// define the filenames used in the project
  ...
  define('FILENAME_STATS_PERIOD', 'stats_period.php');
