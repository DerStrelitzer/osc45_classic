<?php
/*
  $Id: SalesReport.php,v 0.1 2002/12/06 23:52:29 cwi Exp $
...
class SalesReport
{
    ...
    public function __construct($mode, $startDate = "", $endDate = "")
    {
    ...
    function query()
    {
        ...
        for ($i = 0; $i < $this->size; $i++) {
            ...
            switch ($this->mode) {
                ...
                // daily
                case '2':
                    $this->info[$i]['text'] = date(DATE_FORMAT_SHORT, $this->startDates[$i]);
                ...
                // weekly
                case '3':
                    $this->info[$i]['text'] = date(DATE_FORMAT_SHORT, $this->startDates[$i]) . " - " . date(DATE_FORMAT_SHORT, mktime(0, 0, 0, date("m", $this->endDates[$i]), date("d", $this->endDates[$i]) - 1, date("Y", $this->endDates[$i])));
                ...
                // monthly
                case '4':
                    $this->info[$i]['text'] = xprios_date_month_name($this->startDates[$i], true) . ' '. date("Y", $this->startDates[$i]);
