...
class Order
{
    ...
    public function query($order_id)
    {
        $order_query = tep_db_query("select "
            . "customers_id, customers_name, customers_company, customers_street_address, customers_suburb, customers_city, "
            ...
            . "payment_method, payment_class, shipping_method, shipping_class, "
