<?php
/*
  $Id: ShoppingCart.php,v 1.10 2003/06/23 01:18:56 hpdl Exp $
...
// update database
        if (isset($_SESSION['customer_id'])) {
            tep_db_query("update " . TABLE_CUSTOMERS_BASKET . " set customers_basket_quantity = '" . tep_db_input($quantity) . "' where customers_id = '" . (int)$_SESSION['customer_id'] . "' and products_id = '" . tep_db_input($products_id) . "'");
        }
...
// update database
                if (isset($_SESSION['customer_id'])) {
                    tep_db_query("update " . TABLE_CUSTOMERS_BASKET_ATTRIBUTES . " set products_options_value_id = '" . (int)$value . "' where customers_id = '" . (int)$_SESSION['customer_id'] . "' and products_id = '" . tep_db_input($products_id) . "' and products_options_id = '" . (int)$option . "'");
                }
            }
        }
    }
