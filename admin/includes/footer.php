...
osCommerce provides no warranty and is redistributable under the <a href="http://www.fsf.org/licenses/gpl.txt" target="_blank">GNU General Public License</a>
  ...
  <tr>
    <td align="center" class="smallText">Mod <?php echo CUSTOMIZED_VERSION; ?>, 2003-2021 by <a href="http://forums.oscommerce.de/index.php?showuser=36" target="_blank">Ingo</a>, powered by <a href="http://www.oscommerce.com" target="_blank">osCommerce</a></td>
  </tr>
</table>
<!-- footer_eof //-->
