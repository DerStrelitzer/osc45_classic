<?php
/*
  $Id: affiliate_application_top.php,v 1.10 2003/02/24 00:47:27 harley_vb Exp $
...
// include the language translations
  require(DIR_WS_LANGUAGES . 'affiliate_' . $_SESSION['language'] . '.php');
...
// If an order is deleted delete the sale too (optional)
  if (isset($_GET['action']) && $_GET['action'] == 'deleteconfirm' && basename($_SERVER['SCRIPT_FILENAME']) == FILENAME_ORDERS && AFFILIATE_DELETE_ORDERS == 'true') {
    $affiliate_oID = intval(xprios_prepare_get('oID'));
    tep_db_query("delete from " . TABLE_AFFILIATE_SALES . " where affiliate_orders_id = '" . $affiliate_oID . "' and affiliate_billing_status != 1");
  }
