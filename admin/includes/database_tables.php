...
// define the database table names used in the project
  ...
  define('TABLE_FEATURED_PRODUCTS', 'featured_products');
  define('TABLE_INFO_TEXTE', 'info_texte');
  define('TABLE_INVOICE_NUMBER', 'invoice_number');
