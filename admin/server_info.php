...
<?php
    ...
    preg_match('#<body>(.*)</body>#s', str_replace('border: 1px', '', $phpinfo), $matches);

    echo '<table cellpadding="3" width="597" style="border: 1px solid #000000;">' .
         '  <tr><td align="right" style="padding-bottom:0;">mod&nbsp;' . CUSTOMIZED_VERSION . '&nbsp;by&nbsp;Ingo</td>' .
         '  </tr>' .
         '  <tr><td><a href="http://www.oscommerce.com" target="_blank"><img border="0" src="images/oscommerce.gif" alt=" ' . STORE_NAME . ' " /></a><h1 class="p"> ' . PROJECT_VERSION . '</h1></td>' .
         '  </tr>' .
         '</table>';
    echo $matches[1];
} else {
