...
define('DATE_FORMATTER_LOCALE', 'en_GB'); // this is used with tep_date_long()
define('DATE_FORMATTER_DATE', 'EEEE, dd. MMMM YYYY'); // unused at this time, reserved
define('DATE_FORMATTER_DATETIME', 'EEEE, MMMM dd, YYYY, HH:mm:ss'); // this is reserved for tep_date_long()
define('DATE_FORMAT_LONG', '%A %d %B, %Y');  // this is used with tep_date_long()
define('DATE_FORMAT_SHORT', 'm/d/Y');  // this is used with date()
define('DATE_FORMAT', 'm/d/Y'); // this is used with date()
define('DATE_TIME_FORMAT', DATE_FORMAT_SHORT . ' h:i:s a'); // this is used with date()

// text for date of birth example
define('DOB_FORMAT_STRING', 'mm/dd/yyyy');

define('DATE_DAY_NAMES', 'monday,tuesday,wednesday,thursday,friday,saturday,sunday');
define('DATE_DAY_NAMES_SHORT', 'mo,tu,we,th,fr,sa,su');
define('DATE_MONTH_NAMES', 'january,february,march,april,may,june,july,august,september,october,november,december');
define('DATE_MONTH_NAMES_SHORT', 'jan,feb,mar,apr,may,jun,jul,aug,sep,oct,nov,dec');
...
// Ingo
define('TEXT_SPECIAL_PRICE_OLD', 'former');
define('TEXT_SPECIAL_PRICE_NOW', 'now');

define('BOX_INFORMATION_ABOUT_US', 'We about us');
define('BOX_HEADING_VIEWED_PRODUCTS', 'Last seen');

define('TABLE_HEADING_LATEST_NEWS', 'Latest News');

define('TEXT_DOWNLOAD_CONDITIONS_PDF', 'Click here to download the conditions as PDF. ACROBAT-Reader is required to read.');
define('TEXT_DOWNLOAD_ACROBAT', 'Click on the right button to download the newest version of ACROBAT-Reader.');

define('TEXT_READ_MORE', 'read more');
define('YOU_ARE_HERE','You\'re here:&nbsp;');

define('SIMPLE_WORD_TAX', 'tax');
define('SIMPLE_WORD_SHIPPING', 'shipping expenses');
define('SIMPLE_WORD_INCL', 'incl.');
define('SIMPLE_WORD_EXCL', 'plus');

define('DOWNLOAD_NOT_FREE', 'not free');

define('BOX_WIDERRUF','Right of returns?');
...
define ('DISCLAIMER', '<font size="+1" color="ff0000"><div align="center"><b>Attention!</b><br />We disclaim all responsibility for content of all linked websites outer our domain <br />"<b>' . HTTP_SERVER .  '</b>"!</div></font>');
// Who's online
...
define('BOX_REVIEWS_WRITE_REVIEW', 'Write a review on');
...
define('BOX_TELL_A_FRIEND_TEXT', 'Tell someone you know about <b>%s</b>.');
...
define('TEXT_GREETING_PERSONAL', 'Welcome back <span class="greetUser">%s!</span> Would you like to see which <a href="%s"><span class="underlined">new products</span></a> are available to purchase?');
define('TEXT_GREETING_PERSONAL_RELOGON', '<small>If you are not %s, please <a href="%s"><span class="underlined">log yourself in</span></a> with your account information.</small>');
define('TEXT_GREETING_GUEST', 'Would you like to <a href="%s"><span class="underlined">log yourself in</span></a> or would you prefer to <a href="%s"><span class="underlined">create an account</span></a>?');
...
All prices includes tax but no <a href="' . tep_href_link(FILENAME_SHIPPING) . '" class="bodyfooter">shippingcost</a>.<br />
We refer to our <a href="' . tep_href_link(FILENAME_CONDITIONS) . '" class="bodyfooter">conditions of use</a>!
