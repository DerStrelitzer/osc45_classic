...
define('HEADING_TITLE', 'Partnerprogramm - Häufig gestellte Fragen');

define('TEXT_INFORMATION', '' . STORE_NAME . ' hat diese FAQ geschrieben, um Ihnen die häufigsten Fragen zu unserem Partnerprogramm schnell beantworten zu können.<br />
 Falls Sie weitere Fragen haben <a href="' . tep_href_link(FILENAME_AFFILIATE_CONTACT). '"> <span class="underlined">kontaktieren</span></a> Sie uns bitte für weitere Informationen.<br />
<ul>
...
<hr width="90%" />
<br />
<font color="#000000" size="3"><b><span class="underlined">Häufig gestellte Fragen</span></b></font>
