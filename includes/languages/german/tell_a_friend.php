...
define('HEADING_TITLE_RAW', 'Empfehlen Sie \'%s\' weiter');
...
define('TEXT_EMAIL_SUCCESSFUL_SENT', 'Ihre E-Mail über <b>%s</b> wurde gesendet an <b>%s</b>.');
...
define('ERROR_TO_ADDRESS', 'Fehler: Die Empfänger-E-Mail-Adresse darf nicht leer sein.');
define('ERROR_FROM_NAME', 'Fehler: Der Absendername (Ihr Name) muss angegeben werden.');
define('ERROR_FROM_ADDRESS', 'Fehler: Die Absenderadresse muss eine gültige E-Mail-Adresse sein.');
