...
/*
  ...
  Copyright (c) 2012 xPrioS
  Copyright (c) 2002 osCommerce

  Released under the GNU General Public License
*/

define('HEADING_CONDITIONS_INFORMATION', 'Conditions of Use');
define('TEXT_CONDITIONS_CONFIRM', 'I have read the <a href="' . tep_href_link(FILENAME_CONDITIONS) . '" class="underlined">conditions</a> and aaccept them. My <a href="' . tep_href_link(FILENAME_CONDITIONS) . '" class="underlined">right of withdrawal</a>, I have taken note.');
define('TEXT_CONDITIONS_DOWNLOAD', 'Download Conditions');
...
define('TEXT_ENTER_PAYMENT_INFORMATION', 'We offer the following manner of payment to you.');
