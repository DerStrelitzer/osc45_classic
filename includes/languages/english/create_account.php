...
define('HEADING_TITLE_RAW', 'My Account Information');

define('TEXT_ORIGIN_LOGIN', '<span class="smallText warning"><b><b>NOTE:</b></span> If you already have an account with us, please login at the <a href="%s"><span class="underlined">login page</span></a>.');
