...
define('HEADING_TITLE', 'Your order is registered');

define('TEXT_SUCCESS', 'Your order has been successfully registered and will be processed so fast as possible. Further informations you will receive by email.');
