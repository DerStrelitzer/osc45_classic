<?php
/*
  $Id: affiliate_german.php,v 1.10 2003/02/15 17:54:43 harley_vb Exp $
...
define('ENTRY_AFFILIATE_ACCEPT_AGB', 'Bitte bestätigen Sie, dass Sie mit unseren <a target="_blank" href="' . tep_href_link(FILENAME_AFFILIATE_TERMS, '', 'SSL') . '">AGB\'s</a> einverstanden sind.');
define('ENTRY_AFFILIATE_AGB_ERROR', '&nbsp;<small style="color:#f00">Sie müssen sich mit unseren AGB einverstanden erklären.</small>');
define('ENTRY_AFFILIATE_PAYMENT_CHECK', 'Empfänger des Schecks:');
