<?php
/*
  $Id: affiliate_english.php,v 1.6 2003/02/14 16:31:39 harley_vb Exp $
...
define('ENTRY_AFFILIATE_ACCEPT_AGB', 'Check here to indicate that you have read and agree to the <a target="_blank" href="' . tep_href_link(FILENAME_AFFILIATE_TERMS, '', 'SSL') . '">Associates Terms &amp; Conditions</a>.');
define('ENTRY_AFFILIATE_AGB_ERROR', ' &nbsp;<small style="color:#f00">You must accept our Associates Terms &amp; Conditions</small>');
