...
define('HEADING_TITLE_RAW', 'Datos de Mi Cuenta');

define('TEXT_ORIGIN_LOGIN', '<span class="smallText warning"><b><b>NOTA:</b></span> Si ya ha pasado por este proceso y tiene una cuenta, por favor <a href="%s"><span class="underlined">entre</span></a> en ella.');

define('EMAIL_SUBJECT', 'Bienvenido a ' . STORE_NAME);
define('EMAIL_GREET_MR', 'Estimado ' . (isset($_POST['lastname'])? stripslashes($_POST['lastname']):'') . ',' . "\n\n");
define('EMAIL_GREET_MS', 'Estimado ' . (isset($_POST['lastname'])? stripslashes($_POST['lastname']):'') . ',' . "\n\n");
define('EMAIL_GREET_NONE', 'Estimado ' . (isset($_POST['firstname'])? stripslashes($_POST['firstname']):'') . ',' . "\n\n");
