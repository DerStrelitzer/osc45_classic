...
// Ingo
define('DO_YOU_MEAN_ALTER', '¿O usted significó posiblemente el');
...
define('TEXT_SEARCH_IN_DESCRIPTION', 'Buscar tambien en la descripción');
...
define('TEXT_SEARCH_HELP_LINK', '<span class="underlined">Ayuda</span> [?]');
