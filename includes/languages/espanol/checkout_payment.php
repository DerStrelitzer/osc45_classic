...
define('HEADING_CONDITIONS_INFORMATION', 'Condiciones de Uso');
define('TEXT_CONDITIONS_CONFIRM', 'He leído los <a href="' . tep_href_link(FILENAME_CONDITIONS) . '" class="underlined">términos y condiciones</a> y estoy de acuerdo. Mi <a href="' . tep_href_link(FILENAME_CONDITIONS) . '" class="underlined">derecho de retirada</a> de tomado nota.');
define('TEXT_CONDITIONS_DOWNLOAD', 'Download Condiciones');
