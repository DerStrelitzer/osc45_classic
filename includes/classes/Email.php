...
class Email 
{
    ...
    public function __construct($headers = '')
    {
        ...
        if (defined('EMAIL_LINEFEED') && EMAIL_LINEFEED == 'CRLF') {
            $this->lf = "\r\n";
        }
...
/**
 * the MIME version header is first.
 */
 ...
 */
    ...
    private function find_html_images($images_dir)
    {
 ...
 */
    ...
    private function add_html_image($file, $name = '', $c_type='application/octet-stream')
    {
        $this->html_images[] = [
            'body'   => $file,
            'name'   => $name,
 ...
 */
    ...
    private function add_attachment($file, $name = '', $c_type='application/octet-stream', $encoding = 'base64')
    {
        $this->attachments[] = [
            'body'     => $file,
            'name'     => $name,
 ...
 */
    private function add_text_part(&$obj, $text)
    {
 ...
 */
    ...
    private function add_html_part(&$obj)
    {
 ...
 */
    private function add_mixed_part()
    {
 ...
 */
    private function add_alternative_part(&$obj)
    {
 ...
 * Adds a html subpart to a mime_part object
 */
    private function add_related_part(&$obj)
    {
 ...
 */
    private function add_html_image_part(&$obj, $value)
    {
 ...
 */
    private function add_attachment_part(&$obj, $value)
    {
        $params['content_type'] = $value['c_type'];
 ...
 */
    ...
    public function send($to_name, $to_addr, $from_name, $from_addr, $subject = '', $headers = '')
    {
        ...
        if (
            strpos($to_name, "\n") !== false ||
            strpos($to_name, "\r") !== false ||
            strpos($to_addr, "\n") !== false || 
            strpos($to_addr, "\r") !== false ||
            strpos($subject, "\n") !== false ||
            strpos($subject, "\r") !== false ||
            strpos($from_name, "\n") !== false ||
            strpos($from_name, "\r") !== false ||
            strpos($from_addr, "\n") !== false ||
            strpos($from_addr, "\r") !== false
            ) {
            return false;
        }
