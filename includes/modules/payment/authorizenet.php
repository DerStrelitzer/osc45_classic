...
class authorizenet extends PaymentModules
{
    public 
        $code = 'authorizenet';
...
// class constructor
    public function __construct()
    {
        ...
        $this->enabled = (defined('MODULE_PAYMENT_AUTHORIZENET_STATUS') && MODULE_PAYMENT_AUTHORIZENET_STATUS == 'ja') ? true : false;
        $this->sort_order = defined('MODULE_PAYMENT_AUTHORIZENET_SORT_ORDER') ? MODULE_PAYMENT_AUTHORIZENET_SORT_ORDER : 0;

        if (defined('MODULE_PAYMENT_AUTHORIZENET_SORT_ORDER') && (int)MODULE_PAYMENT_AUTHORIZENET_ORDER_STATUS_ID > 0) {
...
// class methods
    ...
    public function selection()
    {
        ...
        for ($i=1; $i<13; $i++) {
            $expires_month[] = [
                'id' => sprintf('%02d', $i), 
                'text' => xprios_date_string('%B',mktime(0,0,0,$i,1,2000))
            ];
        }
    ...
    public function confirmation()
    {
        ...
        $confirmation = [
            ...
            'fields' => [
                ...
                [
                    'title' => MODULE_PAYMENT_AUTHORIZENET_TEXT_CREDIT_CARD_EXPIRES,
                    'field' => xprios_date_string('%B, %Y', mktime(0,0,0,$_POST['authorizenet_cc_expires_month'], 1, '20' . $_POST['authorizenet_cc_expires_year']))
                ]
            ]
        ];
    ...
    public function process_button()
    {
        ...
        . tep_draw_hidden_field('x_Cust_ID', $_SESSION['customer_id'])
        . tep_draw_hidden_field('x_Email_Customer', ((MODULE_PAYMENT_AUTHORIZENET_EMAIL_CUSTOMER == 'ja') ? 'TRUE': 'FALSE'))
    ...
    {
        tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Authorize.net Modul', 'MODULE_PAYMENT_AUTHORIZENET_STATUS', 'ja', 'Wird die Zahlung durch \'Authorize.net\' angeboten?', '6', '0', 'tep_cfg_select_option(array(\'ja\', \'nein\'), ', now())");
        tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Login Benutzername', 'MODULE_PAYMENT_AUTHORIZENET_LOGIN', 'testing', 'Hier wird der Benutzername für den \'Authorize.net\' Service eingetragen.', '6', '0', now())");
        tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Transaktions-Schlüssel', 'MODULE_PAYMENT_AUTHORIZENET_TXNKEY', 'Test', 'Hier wird der Transaktion-Schlüssel (transaction key) zur Entschlüsselung der Daten eingetragen.', '6', '0', now())");
        tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Transactionsmodus', 'MODULE_PAYMENT_AUTHORIZENET_TESTMODE', 'Test', 'Hier wird der Transaktionsmodus für den Zahlungsprozess eingetragen.<br /><b>Test</b> = zum testen<br /><b>Production</b> = zum Betrieb', '6', '0', 'tep_cfg_select_option(array(\'Test\', \'Production\'), ', now())");
        tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Transactionmethode', 'MODULE_PAYMENT_AUTHORIZENET_METHOD', 'Credit Card', 'Transaktionsmethode zur Benutzung der Zahlung.<br /><b>credit card</b> = Kreditkarte<br /><b>eCheck</b> = elek. Scheck', '6', '0', 'tep_cfg_select_option(array(\'Credit Card\', \'eCheck\'), ', now())");
        tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Kundennotiz', 'MODULE_PAYMENT_AUTHORIZENET_EMAIL_CUSTOMER', 'ja', 'Soll \'Authorize.Net\' per E-Mail eine Nachricht an den Kunden schicken?', '6', '0', 'tep_cfg_select_option(array(\'ja\', \'nein\'), ', now())");
        tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sortierreihenfolge', 'MODULE_PAYMENT_AUTHORIZENET_SORT_ORDER', '0', 'Reihenfolge der Anzeige. Niedrigste zuerst.<center>_______________________<br />| deutsche Übersetzung |<br />|_____<a href=\"mailto:videoundco@web.de?subject=Frage zu osCommerce\"><b><u>In</u>g<u>o Malchow</u></b></a>____|</center>', '6', '0', now())");
        tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) values ('Zone', 'MODULE_PAYMENT_AUTHORIZENET_ZONE', '0', 'Wird hier eine Zone ausgewählt, wird die Zahlungsart nur für Aufträge aus dieser Zone möglich.', '6', '2', 'tep_get_zone_class_title', 'tep_cfg_pull_down_zone_classes(', now())");
        tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) values ('Bestellstatus', 'MODULE_PAYMENT_AUTHORIZENET_ORDER_STATUS_ID', '0', 'Wird eine Bestellung ausgelöst, so wird dieser, die hier eingetragene Stufe des Bestellstatus zugewiesen.', '6', '0', 'tep_cfg_pull_down_order_statuses(', 'tep_get_order_status_name', now())");
    }
