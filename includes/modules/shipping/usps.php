...
class usps extends ShippingModules
{
    public 
        $code = 'usps',
        $types = [
...
// class constructor
    public function __construct()
    {
        ...
        $this->tax_class = defined('MODULE_SHIPPING_USPS_TAX_CLASS') ? MODULE_SHIPPING_USPS_TAX_CLASS : 0;
      ...
      if (is_array($uspsQuote)) {
        if (isset($uspsQuote['error'])) {
          ...
          for ($i=0; $i<$size; $i++) {
            ...
            $this_ups_costs = ($cost + MODULE_SHIPPING_USPS_HANDLING) * $shipping_num_boxes;
...
*/
    ...
    public function install() {
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) values ('Tax Class', 'MODULE_SHIPPING_USPS_TAX_CLASS', '0', '<b>unbenutzt!</b> Es wird der höchste Steuersatz aus dem Warenkorb benutzt.<!-- Use the following tax class on the shipping fee. -->', '6', '0', 'tep_get_tax_class_title', 'tep_cfg_pull_down_tax_classes(', now())");
