...
?>
          <tr>
            ...
            <td class="main"><?php echo tep_draw_input_field('suburb', isset($entry['entry_suburb']) ? (string)$entry['entry_suburb']:'') . '&nbsp;' . (tep_not_null(ENTRY_SUBURB_TEXT) ? '<span class="inputRequirement">' . ENTRY_SUBURB_TEXT . '</span>': ''); ?></td>
          </tr>
<?php
}
?>
...
?>
          <tr>
            ...
            <td class="main"><?php echo tep_get_country_list('country', (isset($entry['entry_country_id'])?$entry['entry_country_id']:STORE_COUNTRY)) . '&nbsp;' . (tep_not_null(ENTRY_COUNTRY_TEXT) ? '<span class="inputRequirement">' . ENTRY_COUNTRY_TEXT . '</span>': ''); ?></td>
          </tr>
<?php
if ((isset($_GET['edit']) && $_SESSION['customer_default_address_id'] != $_GET['edit']) || !isset($_GET['edit']) ) {
?>
          <tr>
            <td colspan="2"><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
          </tr>
