<?php
/*
  $Id: affiliate_functions.php,v 1.9 2003/07/12 11:48:00 simarilius Exp $
...
*/
  ...
  function affiliate_insert ($sql_data_array, $affiliate_parent = 0) {
    ...
    if ($affiliate_parent > 0) {
      $affiliate_root_query = tep_db_query('select affiliate_root, affiliate_rgt, affiliate_lft from ' . TABLE_AFFILIATE . ' where affiliate_id = "' . intval($affiliate_parent) . '"');
