...
*/
  ...
  function tep_show_category($counter) {
    ...
    if (isset($cPath_array) && in_array($counter, $cPath_array)) {
      $categories_string .=  tep_image(DIR_WS_IMAGES . 'desk/box_arrow.gif') . '<b>';
    }
...
<?php
  ...
  new infoBoxHeading($info_box_contents, false, false, tep_href_link(FILENAME_ALL_PRODUCTS));
...
$categories_string .= '<a href="' . tep_href_link(FILENAME_ALL_PRODUCTS) . '"><b>' . ALL_PRODUCTS_LINK . "</b></a>\n";
