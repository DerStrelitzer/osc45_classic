...
if (isset($_GET['action']) && ($_GET['action'] == 'update')) {
    $notify_string = '';
    if (isset($_POST['notify']) && is_array($_POST['notify'])) {
...
$this_content_form = tep_draw_form('order', tep_href_link(FILENAME_CHECKOUT_SUCCESS, 'action=update', 'SSL'));
require(DIR_WS_INCLUDES . 'column_center.php');
?>
      <tr>
        <td><table border="0" width="100%" cellspacing="4" cellpadding="2">
          <tr>
            <td valign="top"><?php echo tep_image(DIR_WS_IMAGES . 'desk/table_background_man_on_board.gif', HEADING_TITLE); ?></td>
...
?>
      ...
      <tr>
        <td align="right" class="main"><?php echo tep_image_submit('button_continue.gif', IMAGE_BUTTON_CONTINUE, 'style="margin-right:10px;"'); ?></td>
      </tr>
      <tr>
        <td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
      </tr>
        ...
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="25%"><table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr>
                <td width="50%"><?php echo tep_draw_separator('pixel_silver.gif', '100%', '1'); ?></td>
                <td width="50%"><?php echo tep_image(DIR_WS_IMAGES . 'desk/checkout_bullet.gif'); ?></td>
              </tr>
            </table></td>
          </tr>
          <tr>
